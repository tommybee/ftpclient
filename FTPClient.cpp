...
CFTPClient::CFTPClient(std::shared_ptr<IBlockingSocket> apSocket, unsigned int uiTimeout/*=10*/,
...
void CFTPClient::SetFileListParser(std::shared_ptr<IFileListParser> apFileListParser)
{
                                           ...
                                           bool fPasv, DWORD dwByteOffset, ITransferNotification& Observer) const
{
   ...
   std::shared_ptr<IBlockingSocket> apSckDataConnection(m_apSckControlConnection->CreateInstance());
...
bool CFTPClient::OpenActiveDataConnection(IBlockingSocket& sckDataConnection, const CCommand& crDatachannelCmd, const tstring& strPath, DWORD dwByteOffset) const
{
   ...
   std::shared_ptr<IBlockingSocket> apSckServer(m_apSckControlConnection->CreateInstance());
